...
class ProductViewPagerAdapter(val context: Context, val ItemList:ArrayList<String>):RecyclerView.Adapter<ProductViewPagerAdapter.ProductViewPagerViewHolder>() {
